...
public interface ClientRepository  extends CrudRepository<Client, Long>{
	...
	@Modifying
	@Query(value = "INSERT INTO Client (nom, prenom,dateNaissance,email,password,profession,catClient) VALUES (:nom,:prenom, :dateNaissance, :email, :password, :profession, :catClient)",nativeQuery = true)
	void insertClient(@Param("nom") String nom, @Param("prenom") String prenom,@Param("dateNaissance") Date dateNaissance, @Param("email") String email,@Param("password") String password, @Param("profession")  Profession profession, @Param("catClient") CategorieClient catClient);
